...
public class AbsentsEntity {
    ...
    private List<AbsenceDetailsEntity> absenceDetailEntities;

    public List<AbsenceDetailsEntity> getAbsenceDetails() {
        return absenceDetailEntities;
    }

    public void setAbsenceDetails(List<AbsenceDetailsEntity> absenceDetailEntities) {
        this.absenceDetailEntities = absenceDetailEntities;
    }
